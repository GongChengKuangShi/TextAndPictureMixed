...
- (void)setupYYLabel {
    YYFPSLabel *label = [[YYFPSLabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width -100, 5, 60, 30)];
    [self.view insertSubview:label aboveSubview:self.MyWebView];
}

- (void)setupWebView {
    
    self.MyWebView.text = @"http://www.baidu.com圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 圆圈勾勒成指纹 印在我的嘴唇 回忆苦涩的吻痕 是树根 春去秋来的茂盛 却遮住了黄昏 寒夜剩我一个人 等清晨 世间最毒的仇恨 是有缘却无分 可惜你从未心疼 我的笨 荒草丛生的青春 倒也过的安稳 代替你陪着我的 是年轮 数着一圈圈年轮 我认真 将心事都封存 密密麻麻是我的自尊 修改一次次离分 我承认 曾幻想过永恒 可惜从没人陪我演这剧本  \r\n 圆圈勾勒成指纹 印在我的嘴唇 回忆苦涩的吻痕 是树根 春去秋来的茂盛13634679713 却遮住了黄昏 寒夜剩我一个人 等清晨 世间最毒的仇恨 是有缘却无分 可惜你从未心疼 我的笨 荒草丛生的青春 倒也过的安稳 代替你陪着我的 是年轮 数着一圈圈年轮 我认真 将心事都封存 密密麻麻是我的自尊 修改一次次离分 我承认 曾幻想过永恒 可惜从没人陪我演这剧本 \n 一圈圈年轮 我认真 将心事都封存 密密麻麻是我的自尊 修改一次次离分 我承认 曾幻想过永恒 可惜从没人陪我演这剧本 78293467@qq.com  可惜从没人陪我演这剧本http://www.weibo.com http://www.QQ.com";
    ...
    //将字符串替换成图片
    [self.MyWebView replaceImage:@"https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1485742601&di=23c9814bfc4d3af2337831f1539ef990&src=http://img.zcool.cn/community/01b76b567269176ac725ad90332d60.jpg" withUrl:nil withSubStr:@"圆圈勾勒成指纹" isAllReplace:YES];

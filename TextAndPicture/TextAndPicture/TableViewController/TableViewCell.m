...
@property (weak , nonatomic) SHTextView *textView;
...
- (void)layoutSubviews {
    ...
    self.textView.frame = CGRectMake(0, 0, self.frame.size.width, 420);
}
...
- (void)setText:(NSString *)text {
    ...
    [self.textView setBackColorWithR:125 G:255 B:0 A:0.2];
    ...
    //将字符串替换成图片
    [self.textView replaceImage:@"https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1485742601&di=23c9814bfc4d3af2337831f1539ef990&src=http://img.zcool.cn/community/01b76b567269176ac725ad90332d60.jpg" withUrl:nil withSubStr:@"圆圈勾勒成指纹" isAllReplace:YES];
    ...
    [self.textView replaceAtStr:@"天马邮箱" AtStrColorR:255 G:10 B:0 A:1 Url:@"mailto://1358391345@qq.com" SubStr:@"1358391345@qq.com"];
